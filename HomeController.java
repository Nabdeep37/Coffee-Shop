...
public class HomeController {
    ...
    public String submitContactForm(@RequestParam String name, @RequestParam String email, @RequestParam String message, @RequestParam String rating, Model model) {
        // Process form submission here, e.g., save the data to a database or send an email
        // For simplicity, let's just add a message attribute to the model
        model.addAttribute("message", "Thank you, " + name + ". We have received your message.");
        return "redirect:/contact";
    }

    @GetMapping("/products")
    public String showProducts(Model model) {
        // Add products to the model if needed
        return "products";
    }
